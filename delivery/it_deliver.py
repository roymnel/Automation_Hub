# it_deliver.py
# Advanced delivery script with PDF + email for IT & DevOps Automation
...
def generate_receipt_pdf(output_path="receipt_it.pdf"):
    pdf = FPDF()
    pdf.add_page()
    ...
    pdf.cell(200, 10, txt="Automation Hub – IT & DevOps Service Receipt", ln=True, align='C')

    pdf.set_text_color(0, 0, 0)
    pdf.ln(10)
    pdf.cell(200, 10, txt=f"Date: {datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')}", ln=True)
    pdf.cell(200, 10, txt="Service: IT & DevOps Automation", ln=True)
...
def deliver_service(customer_email):
    print("=== IT & DEVOPS SERVICE DELIVERY ===")
    print("[✓] Delivery started...")
    pdf_path = generate_receipt_pdf()

    subject = "Your IT & DevOps Automation Receipt"
    body = (
        "Hello,\n\n"
        "Thank you for your purchase of the IT & DevOps Automation service from Automation Hub.\n"
